...
> **Generated:** 2026-06-29T03:07:19Z
...
|----------|:-----:|---------------------|
| **HIGH_CONFIDENCE_NOVEL** | 12 | Primary novelty claim — publish as novel family |
| **NOVEL** | 4 | Primary novelty claim — publish as novel family |
...
| 18 | SEED-008_VAR_044 | SEED-008 | 0.832 | 0.600 | [NV] NOVEL | indolicidin_analog | 4 |
...
|:----:|----------|:----------:|----------------|
| **1** | HIGH_CONFIDENCE_NOVEL (< 40% sim, no motif concern) | 12 | Primary breakthrough targets. Lead publication. |
| **2** | NOVEL (< 50% sim) | 4 | Claim as novel family. Verify mechanism unique. |
