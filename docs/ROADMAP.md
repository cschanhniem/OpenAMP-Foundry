...
| ~~AUPRC alongside AUROC~~ | ~~Better metric for class-imbalanced AMP datasets~~ | **Done** (PR #58; expanded benchmark PR #110) — current expanded-benchmark pipeline AUPRC = 0.8164; original demo-set AUPRC = 0.8627 |
