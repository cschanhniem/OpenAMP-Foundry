...
| SEED-006 Met oxidation (ALL 4 pilot variants) | Met at position 9 in all SEED-006 pilot sequences (inherited from mastoparan-X template INWKGIAA**M**AKKLL); Met9→MetO disrupts helix hydrophobic face packing, typically 5–20× MIC loss; **Nle (norleucine) substitution at position 9 REQUIRED** in synthesis order ("M9Nle"); store at −80°C under inert atmosphere; HPLC purity mandatory at receipt — WET_LAB_HANDOFF.md SEED-006 synthesis note updated to reflect this; previously documented as "No Met" in error |
